      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          <div class="col-4 pt-1">
            <a class="text-muted" href="{{ route('cart.index') }}"><i class="fa fa-shopping-cart mr-1"></i>Panier <span class="badge badge-pill badge-dark">{{ Cart::count() }}</a>
          </div>
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between">
            @foreach (App\Models\Category\Category::all() as $category)
              <a class="p-2 text-muted" href="{{ route('homePage', ['categorie' => $category->slug]) }}">{{ $category->name }}</a>
            @endforeach
        </nav>
      </div>
